...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_userprofile', 'picture', self.gf('django.db.models.fields.CharField')(max_length=199))

    def backwards(self, orm):

        # Changing field 'UserProfile.picture'
        db.alter_column('main_userprofile', 'picture', self.gf('django.db.models.fields.CharField')(max_length=200))
