...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('main_episode', 'rating')
        ...
        # Changing field 'episode.aired'
        db.alter_column('main_episode', 'aired', self.gf('django.db.models.fields.DateField')())

        # Changing field 'episode.name'
        db.alter_column('main_episode', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Adding field 'episode.rating'
        db.add_column('main_episode', 'rating',
        ...
        # Changing field 'episode.ssemapid'
        db.alter_column('main_episode', 'ssemapid', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'episode.aired'
        db.alter_column('main_episode', 'aired', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'episode.name'
        db.alter_column('main_episode', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))
