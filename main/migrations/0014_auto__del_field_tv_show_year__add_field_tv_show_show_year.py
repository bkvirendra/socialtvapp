...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'tv_show.show_year'
        db.add_column('main_tv_show', 'show_year',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'tv_show.show_year'
        db.delete_column('main_tv_show', 'show_year')
    ...
    models = {
        ...
        'main.tv_show': {
            ...
            'show_year': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
