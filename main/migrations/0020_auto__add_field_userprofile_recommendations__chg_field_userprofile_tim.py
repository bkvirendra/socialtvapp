...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.recommendations'
        db.add_column('main_userprofile', 'recommendations',
                      self.gf('jsonfield.fields.JSONField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'UserProfile.timestamp_added'
        db.alter_column('main_userprofile', 'timestamp_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 2, 4, 0, 0)))

    def backwards(self, orm):
        # Deleting field 'UserProfile.recommendations'
        db.delete_column('main_userprofile', 'recommendations')


        # Changing field 'UserProfile.timestamp_added'
        db.alter_column('main_userprofile', 'timestamp_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
