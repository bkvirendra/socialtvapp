...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.access_token'
        db.alter_column('main_userprofile', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'UserProfile.email'
        db.alter_column('main_userprofile', 'email', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'UserProfile.access_token'
        db.alter_column('main_userprofile', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'UserProfile.email'
        db.alter_column('main_userprofile', 'email', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'main.love': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'og_id': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'main.temp_imdb_dump': {
            'Meta': {'object_name': 'temp_imdb_dump'},
            'html_page': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'main.tv_show': {
            ...
            'rating': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'null': 'True', 'blank': 'True'}),
        ...
        'main.userprofile': {
            ...
            'access_token': ('django.db.models.fields.CharField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),
            ...
            'picture': ('django.db.models.fields.CharField', [], {'max_length': '199', 'blank': 'True'}),
