...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_userprofile', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=199, null=True))
    ...
    models = {
        ...
        'main.userprofile': {
            ...
            'access_token': ('django.db.models.fields.CharField', [], {'max_length': '199', 'null': 'True', 'blank': 'True'}),
