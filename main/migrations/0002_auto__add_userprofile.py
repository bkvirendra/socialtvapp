...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_userprofile', (
            ...
            ('facebook_id', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ...
            ('age_range', self.gf('jsonfield.fields.JSONField')()),
            ('picture', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('television', self.gf('jsonfield.fields.JSONField')()),
        ))
    ...
    models = {
        ...
        'main.userprofile': {
            ...
            'age_range': ('jsonfield.fields.JSONField', [], {}),
            ...
            'television': ('jsonfield.fields.JSONField', [], {}),
