...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'tv_show.dislikes'
        db.alter_column('main_tv_show', 'dislikes', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'tv_show.reviewed'
        db.alter_column('main_tv_show', 'reviewed', self.gf('django.db.models.fields.IntegerField')(null=True))
        ...
        # Changing field 'tv_show.likes'
        db.alter_column('main_tv_show', 'likes', self.gf('django.db.models.fields.IntegerField')(null=True))
        ...
        # Changing field 'tv_show.show_year'
        db.alter_column('main_tv_show', 'show_year', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'tv_show.image_wide'
        db.alter_column('main_tv_show', 'image_wide', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'tv_show.twitter'
        db.alter_column('main_tv_show', 'twitter', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'tv_show.image_square'
        db.alter_column('main_tv_show', 'image_square', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'tv_show.dislikes'
        db.alter_column('main_tv_show', 'dislikes', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'tv_show.reviewed'
        db.alter_column('main_tv_show', 'reviewed', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'tv_show.image_iphone'
        db.alter_column('main_tv_show', 'image_iphone', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'tv_show.likes'
        db.alter_column('main_tv_show', 'likes', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'tv_show.images'
        db.alter_column('main_tv_show', 'images', self.gf('jsonfield.fields.JSONField')(default=''))

        # Changing field 'tv_show.image_normal'
        db.alter_column('main_tv_show', 'image_normal', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'tv_show.guru'
        db.alter_column('main_tv_show', 'guru', self.gf('jsonfield.fields.JSONField')(default=''))

        # Changing field 'tv_show.show_year'
        db.alter_column('main_tv_show', 'show_year', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'tv_show.gid'
        db.alter_column('main_tv_show', 'gid', self.gf('django.db.models.fields.CharField')(default=0, max_length=200))

        # Changing field 'tv_show.status'
        db.alter_column('main_tv_show', 'status', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'tv_show.description'
        db.alter_column('main_tv_show', 'description', self.gf('django.db.models.fields.TextField')(default=0))

        # Changing field 'tv_show.netflix_link'
        db.alter_column('main_tv_show', 'netflix_link', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'tv_show.facebook_url'
        db.alter_column('main_tv_show', 'facebook_url', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'tv_show.starring'
        db.alter_column('main_tv_show', 'starring', self.gf('jsonfield.fields.JSONField')(default=''))

        # Changing field 'tv_show.banner'
        db.alter_column('main_tv_show', 'banner', self.gf('django.db.models.fields.CharField')(default='', max_length=500))

        # Changing field 'tv_show.image_banner'
        db.alter_column('main_tv_show', 'image_banner', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'tv_show.url'
        db.alter_column('main_tv_show', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'tv_show.title'
        db.alter_column('main_tv_show', 'title', self.gf('django.db.models.fields.CharField')(default=0, max_length=200))

        # Changing field 'tv_show.summary'
        db.alter_column('main_tv_show', 'summary', self.gf('django.db.models.fields.TextField')(default=0))

        # Changing field 'tv_show.trailer_link'
        db.alter_column('main_tv_show', 'trailer_link', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'tv_show.itunes_link'
        db.alter_column('main_tv_show', 'itunes_link', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'tv_show.amazon_link'
        db.alter_column('main_tv_show', 'amazon_link', self.gf('django.db.models.fields.CharField')(default='', max_length=500))

        # Changing field 'tv_show.image_thumbnail'
        db.alter_column('main_tv_show', 'image_thumbnail', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'tv_show.hulu_link'
        db.alter_column('main_tv_show', 'hulu_link', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'tv_show.showtimes'
        db.alter_column('main_tv_show', 'showtimes', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
