...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.generated_recommendations'
        db.add_column('main_userprofile', 'generated_recommendations',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.friends_recommendations'
        db.add_column('main_userprofile', 'friends_recommendations',
                      self.gf('jsonfield.fields.JSONField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.generated_recommendations'
        db.delete_column('main_userprofile', 'generated_recommendations')

        # Deleting field 'UserProfile.friends_recommendations'
        db.delete_column('main_userprofile', 'friends_recommendations')
