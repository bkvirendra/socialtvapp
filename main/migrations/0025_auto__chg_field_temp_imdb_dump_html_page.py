...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'temp_imdb_dump.html_page'
        db.alter_column('main_temp_imdb_dump', 'html_page', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'temp_imdb_dump.html_page'
        db.alter_column('main_temp_imdb_dump', 'html_page', self.gf('jsonfield.fields.JSONField')())
