...
def get_trending():
    shows = json.dumps(xmltodict.parse(requests.get("http://api.getglue.com/v2/glue/popular?oauth_consumer_key=cbe1ee277ab21864ea171c1c5400917c&category=tv_shows").content))
    for show in shows.get(""):
        print show.get("title")
    ## prints the shows
    ## retur the shows object
